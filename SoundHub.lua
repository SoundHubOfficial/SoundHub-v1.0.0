...
print("SoundHub Version: " .. ACEWARE_VERSION_NUMBER)
print("SoundHub Version 'vX.X.X':   " .. ACEWARE_VERSION_VNUM)
print("SoundHub Version 'version X.X.X':   " .. ACEWARE_VERSION_LONG)
...
local Window = Rayfield:CreateWindow({
    Name = "SoundHub " .. ACEWARE_VERSION_VNUM,
    LoadingTitle = "SoundHub",
...
-- ELEMENTS
     ...
     -- INFO ELEMENTS
    TabInfo:CreateParagraph({Title = "SoundHub Version", Content = ACEWARE_VERSION_NUMBER})
    ...
    TabInfo:CreateParagraph({Title = "SoundHub Discord", Content = "discord.gg/FJfpYDwHeq"})
...
-- FINISH LOADING
print("SoundHub " .. ACEWARE_VERSION_VNUM .. " loaded!")

Rayfield:Notify({
    Title = "Welcome to SoundHub! [ " .. ACEWARE_VERSION_VNUM .. " ]",
    Content = "Join our Discord! [ .gg/FJfpYDwHeq ]",
    Duration = 5,
    Image = 97253185897302,
    Actions = {
        Ignore = {
            Name = "Close",
        }
